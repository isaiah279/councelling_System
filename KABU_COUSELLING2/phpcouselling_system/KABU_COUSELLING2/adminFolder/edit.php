...
<form action="../AdminFolder/studentList.php" method="post">
  ...
  <label><b>Name:</b></label><br>
		<input type="text" placeholder="Enter Full Name" name="fname"value="<?php echo $row['fname']?>" required><br>
...
<div class="split right">
  ...
  <label><b>Registration Number:</b></label><br>
		<input type="text" placeholder="Enter Registration number" name="regnumber"value="<?php echo $row['regnumber']?>" required><br>
    ...
    <label><b>Message:</b></label><br>
		<textarea name="texts" id="" cols="30" rows="10">value="<?php echo $row['texts']?>"</textarea><br>
